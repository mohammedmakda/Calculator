...
public class StateAddTimesA implements IState {

	private Calculator _calculator;
	private int _leftArg;
	private int _rightArg;

	public StateAddTimesA(Calculator calculator, int left, int right) {
	...
	public void pressDigitKey(int digit) {
		_calculator.setState(new StateAddTimesB(_calculator,_leftArg,_rightArg,digit));
	}
