...
public class StateSubDivideA implements IState {

	private Calculator _calculator;
	private int _leftArg;
	private int _rightArg;

	public StateSubDivideA(Calculator calculator, int left, int right) {
	...
	public void pressDigitKey(int digit) {
		_calculator.setState(new StateSubDivideB(_calculator,_leftArg,_rightArg,digit));
	}
