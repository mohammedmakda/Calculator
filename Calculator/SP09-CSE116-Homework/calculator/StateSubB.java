...
public class StateSubB implements IState {
	 ...
	 * 
	 */
	public StateSubB(Calculator calculator, int left, int right) {
	...
	public void pressDivideKey() {
		_calculator.setState(new StateSubDivideA(_calculator,_leftArg,_rightArg));
	}
	...
	public void pressTimesKey() {
		_calculator.setState(new StateSubTimesA(_calculator,_leftArg,_rightArg));
	}
